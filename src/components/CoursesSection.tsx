      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {/* Digital Marketing Basic */}
            <div className="group bg-card/50 backdrop-blur-sm border border-border rounded-3xl p-8 hover:border-accent/50 transition-all duration-500 hover:transform hover:scale-105">
          ...
          <div className="group bg-card/50 backdrop-blur-sm border border-accent/50 rounded-3xl p-8 hover:border-accent/70 transition-all duration-500 hover:transform hover:scale-105 relative">
            <div className="absolute -top-3 right-4 bg-accent text-accent-foreground px-4 py-1 rounded-full text-sm font-semibold">
              POPULAR
            </div>
            <div className="text-center mb-6">
              <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="text-center">
          ...
          <div className="max-w-2xl mx-auto bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 hover:border-accent/50 transition-all duration-500">
